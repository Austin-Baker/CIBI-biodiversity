...
species_list_clean_small <- species_list_clean %>%
  filter(N<30)
...
bins_to_do <- species_list_clean_small$BIN[!species_list_clean_small$BIN %in% completed_jobs_names]

mclapply(bins_to_do, FUN = map_creator, mc.cores = 20)
# end of loop
